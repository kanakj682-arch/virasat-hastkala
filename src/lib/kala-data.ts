...
export const craftTypes = ["Silk", "Wood", "Metal", "Pottery", "Textiles", "Jute"] as const;
export const regions = ["Rajasthan", "Madhya Pradesh", "Uttar Pradesh", "Karnataka", "Assam"] as const;

export const products: Product[] = [
  { id: "silk-saree", title: "Handmade Silk Saree", category: "Textiles · Handloom", price: "₹4,999", priceValue: 4999, state: "Madhya Pradesh", craftType: "Silk", artisan: "Sunita Devi", artisanId: "sunita", gi: true, status: "Published", image: silkSaree, imageAlt: "Handwoven Chanderi silk saree with gold zari border", description: "A Chanderi handloom silk saree woven on a pit loom over nine days, coloured with plant-based eco dyes and finished with a fine gold zari border.", tags: ["Chanderi Weave", "Eco Dyes"] },
  { id: "wooden-toy", title: "Handcrafted Wooden Toy", category: "Toys · Woodcraft", price: "₹899", priceValue: 899, state: "Karnataka", craftType: "Wood", artisan: "Kishore Rao", artisanId: "kishore", gi: true, status: "Published", image: woodenToy, imageAlt: "Handcrafted natural wooden elephant toy on wheels", description: "A hand-turned wooden elephant on wheels, shaped from sustainably sourced wood and finished with non-toxic, child-safe colours.", tags: ["Natural Wood", "Non-Toxic"] },
  { id: "brass-idol", title: "Vintage Brass Idol", category: "Home Décor · Metal Craft", price: "₹2,499", priceValue: 2499, state: "Uttar Pradesh", craftType: "Metal", artisan: "Ramesh Vishwakarma", artisanId: "ramesh", status: "Published", image: brassIdol, imageAlt: "Hand-engraved solid brass idol with warm patina", description: "A solid brass idol cast by hand and engraved with traditional motifs, carrying the warm patina that only slow, honest metalwork gives.", tags: ["Solid Brass", "Hand-Engraved"] },
  { id: "blue-pottery", title: "Jaipur Blue Pottery Vase", category: "Home Décor · Pottery", price: "₹1,050", priceValue: 1050, state: "Rajasthan", craftType: "Pottery", artisan: "Meena Devi", artisanId: "meena", gi: true, status: "Published", image: pottery, imageAlt: "Hand-painted Jaipur blue pottery vase with floral motifs", description: "A hand-thrown Jaipur blue pottery vase, painted with free-hand floral motifs and fired low so the glaze keeps its soft, cool blue.", tags: ["Hand Painted", "Lead Free Glaze"] },
  { id: "handwoven-textiles", title: "Handwoven Cotton Runner", category: "Home Textiles · Handloom", price: "₹1,499", priceValue: 1499, state: "Madhya Pradesh", craftType: "Textiles", artisan: "Lata Bai", artisanId: "lata", status: "Published", image: textiles, imageAlt: "Handwoven cotton table runner in earthy natural dyes", description: "A cotton table runner woven on a family handloom and dyed with madder and indigo, so every length carries a slightly different depth of colour.", tags: ["Natural Dyes", "Handloom"] },
  { id: "jute-baskets", title: "Natural Jute Basket Set", category: "Storage · Jute Craft", price: "₹749", priceValue: 749, state: "Assam", craftType: "Jute", artisan: "Arjun Boro", artisanId: "arjun", status: "Published", image: baskets, imageAlt: "Set of handmade natural jute storage baskets", description: "A nesting set of jute baskets coiled entirely by hand from locally grown fibre, strong enough for daily use and fully plastic-free.", tags: ["Plastic Free", "Locally Grown Jute"] },
];
